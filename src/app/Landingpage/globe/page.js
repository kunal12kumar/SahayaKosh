      ...
      <div
        ...
        <motion.div
          ...
          <h2
            ...
            We build connections between borrowers and lenders

          </h2>
          <p
            className="text-center text-base md:text-lg font-normal text-neutral-700 dark:text-neutral-200 max-w-[550px] mt-2 mx-auto">
            This platform is interactive and customizable. Explore how trust and opportunity come together, and don’t forget to share the experience
          </p>
        </motion.div>
        <div
